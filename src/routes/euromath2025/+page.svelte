...
>
	...
	>
		<div id="msg1" class="flex justify-start items-end gap-2.5 mb-5 msg">
		...
		<div id="msg2" class=" justify-start items-end gap-2.5 mb-5 msg" style="display: none;">
		...
		<div id="msg3" class="justify-start items-end gap-2.5 mb-5 msg" style="display: none;">
			<img src="/alicepfp.svg" class="h-full" alt="" />
			<div>
				<div
					class="h-[17px] pl-2.5 justify-start items-center gap-[15px] inline-flex"
		...
		<div id="msg4" class="flex justify-start items-end gap-2.5 mb-5 msg" style="display: none;">
			<div>
				<div
		...
		<div id="msg5" class=" justify-start items-end gap-2.5 mb-5 msg" style="display: none;">
			<img src="/bobpfp.svg" class="h-full" alt="" />
			<div>
				<div
					class="h-[17px] pl-2.5 justify-start items-center gap-[15px] inline-flex"
		...
		<div id="msg6" class="justify-start items-end gap-2.5 mb-5 msg" style="display: none;">
			<img src="/alicepfp.svg" class="h-full" alt="" />
			<div>
				<div
					class="h-[17px] pl-2.5 justify-start items-center gap-[15px] inline-flex"
		...
		<div id="msg7" class="flex justify-start items-end gap-2.5 mb-5 msg" style="display: none;">
			<div>
				<div
					class="h-[17px] w-full pr-2.5 justify-end items-center gap-[15px] inline-flex"
				>
		...
		<div id="msg8" class=" justify-start items-end gap-2.5 mb-5 msg" style="display: none;">
			<img src="/bobpfp.svg" class="h-full" alt="" />
			<div>
				<div
					class="h-[17px] pl-2.5 justify-start items-center gap-[15px] inline-flex"
					...
					if (msg4.style.display != "flex") {
						...
						setTimeout(() => {
							...
							if (msg5 && textmsg5) {
								textmsg5.innerText =
									"Your message is: " +
									decrypt(textmsg2.innerText, key);
