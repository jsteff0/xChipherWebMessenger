		...
		<div class="grid grid-cols-1 gap-5 lg:grid-cols-[290px_1fr]">
			...
			<main class="rounded-[22px] border border-cs-border bg-[rgba(18,25,50,0.84)] p-6 shadow-cs lg:min-h-[700px]">
				...
				{:else if activeTab === 'tab-4'}
					<!-- Flashcards -->
					<section>
						<h2 class="mb-[14px] text-[28px] leading-[1.15] font-semibold">Flashcards</h2>
						<div class="mb-2 flex flex-wrap">
							<span class="mb-2 mr-2 inline-block rounded-full border border-[rgba(124,156,255,0.3)] bg-[rgba(124,156,255,0.14)] px-[10px] py-[6px] text-xs text-white">Question / Answer</span>
							<span class="mb-2 mr-2 inline-block rounded-full border border-[rgba(124,156,255,0.3)] bg-[rgba(124,156,255,0.14)] px-[10px] py-[6px] text-xs text-white">Loaded from JSON</span>
							<span class="mb-2 mr-2 inline-block rounded-full border border-[rgba(124,156,255,0.3)] bg-[rgba(124,156,255,0.14)] px-[10px] py-[6px] text-xs text-white">Chapter 1 only</span>
						</div>
						...
						<div class="flex flex-col gap-[18px]">
							<div class="flex flex-wrap items-center justify-between gap-3">
								...
								<div class="flex flex-wrap gap-2.5">
									<button type="button" class="inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-[rgba(124,156,255,0.28)] bg-[rgba(124,156,255,0.12)] px-[14px] py-[10px] text-sm font-semibold text-white transition duration-200 hover:border-[rgba(124,156,255,0.48)] hover:bg-[rgba(124,156,255,0.2)] disabled:cursor-not-allowed disabled:opacity-45" disabled={currentFlashcardIndex === 0 || !flashcards.length} on:click={previousFlashcard}>← Previous</button>
									<button type="button" class="inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-[rgba(124,156,255,0.28)] bg-[rgba(124,156,255,0.12)] px-[14px] py-[10px] text-sm font-semibold text-white transition duration-200 hover:border-[rgba(124,156,255,0.48)] hover:bg-[rgba(124,156,255,0.2)] disabled:cursor-not-allowed disabled:opacity-45" disabled={!flashcards.length} on:click={toggleFlashcard}>Flip Card</button>
									<button type="button" class="inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-[rgba(124,156,255,0.28)] bg-[rgba(124,156,255,0.12)] px-[14px] py-[10px] text-sm font-semibold text-white transition duration-200 hover:border-[rgba(124,156,255,0.48)] hover:bg-[rgba(124,156,255,0.2)] disabled:cursor-not-allowed disabled:opacity-45" disabled={flashcards.length < 2} on:click={shuffleFlashcards}>Shuffle</button>
									<button type="button" class="inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-[rgba(124,156,255,0.28)] bg-[rgba(124,156,255,0.12)] px-[14px] py-[10px] text-sm font-semibold text-white transition duration-200 hover:border-[rgba(124,156,255,0.48)] hover:bg-[rgba(124,156,255,0.2)] disabled:cursor-not-allowed disabled:opacity-45" disabled={currentFlashcardIndex === flashcards.length - 1 || !flashcards.length} on:click={nextFlashcard}>Next →</button>
								</div>
							</div>
									...
									<div class={`relative min-h-[420px] transition-transform duration-500 [transform-style:preserve-3d] ${flashcardFlipped ? '[transform:rotateY(180deg)]' : '[transform:rotateY(0deg)]'}`}>
										<article class="absolute inset-0 flex flex-col justify-between rounded-[22px] border border-cs-border bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.02))] p-7 shadow-cs [backface-visibility:hidden]">
											<div>
												...
												<div class="mb-[14px] text-[13px] leading-[1.6] text-cs-muted">{currentFlashcard()?.category || 'Chapter 1'} • {currentFlashcard()?.subchapter || 'Flashcard'}</div>
